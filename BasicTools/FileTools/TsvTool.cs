namespace Valaiorp.BasicTools.FileTools
{
    ...
    public sealed class TsvTool : IFileTool
    {
        public string Id => "tsv-tool";
        public string Name => "TSV Tool";
        public string Description => "Reads and writes TSV files. Parameters: operation (read|write), filePath, content (write only).";
        public ToolType Type => ToolType.Native;
        public IReadOnlyDictionary<string, object> Metadata => new Dictionary<string, object>
        {
            ["SupportedExtensions"] = new[] { ".tsv" },
            ["Delimiter"] = "\t"
        };
